...
class VideoCallViewController: UIViewController {
    ...
    let AppID: String = "ab06548ac1d6447088b655b5fb7f589f"                  // Tutorial Step 1
    ...
    // Tutorial Step 3
    func joinChannel() {
        agoraKit.joinChannel(byKey: "ab06548ac1d6447088b655b5fb7f589f", channelName: "test-channel", info:nil, uid:0) {[weak self] (sid, uid, elapsed) -> Void in
